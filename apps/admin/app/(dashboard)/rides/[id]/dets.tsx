...
export function RideDetailsPage({
  ...
  return (
    <div className="">
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-4 pt-4 border-t">
              ...
              <Link href={`/drivers/${driver?.email}`}>
                View Driver Profile
              </Link>
            </div>
          </CardContent>
          ...
          <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {format(
                        new Date(details.schedule.dates[0]),
                        "MMM d, yyyy"
                      )}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {format(
                        new Date(
                          details.schedule.dates[
                            details.schedule.dates.length - 1
                          ]
                        ),
                        "MMM d, yyyy"
                      )}
                ...
                <div className="p-4 bg-primary/5 rounded-lg">
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {details.schedule.kind}
                      </span>
                    </div>
                    <div className="flex justify-between pt-2 border-t mt-2">
                      <span className="font-medium">Total Cost:</span>
                      <span className="font-bold text-lg">
                        KES {details.schedule.cost?.toLocaleString() || "N/A"}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">Paid:</span>
                      <span className="font-medium">
                        KES {details.schedule.paid?.toLocaleString() || "0"}
                      </span>
                    </div>
                  </div>
                </div>
            ...
            <div className="space-y-2 pt-4 border-t">
              ...
              <div className="p-3 border rounded-lg text-sm">
                {details?.admin_comments || "No comments provided."}
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      {/* Route Map */}
      {details?.schedule?.pickup && details?.schedule?.dropoff && (
        <Card className="mb-8">
          <CardHeader>
